...
public record StartingState(Guid TrackingNumber, string IssuedTo, string IssuedOnBehalfOf, string ReasonForIssuing)
{
    /// <summary>
    /// Specifies details when a ticket is opened in the pending state.
    /// </summary>
    ...
    /// </param>
    /// <param name="reasonForIssuing">A description that explains what the purpose of the process is.</param>
    public StartingState(string issuedTo, string reasonForIssuing) : this(issuedTo, issuedTo, reasonForIssuing)
    {
    }
    ...
    /// </param>
    /// <param name="reasonForIssuing">A description that explains what the purpose of the process is.</param>
    public StartingState(string issuedTo, string issuedOnBehalfOf, string reasonForIssuing)
